                ...
                <div class="grid-layout">
                    ...
                    <div>
                        <div class="form-group">
                            ...
                            <input type="text" id="title" name="title" class="form-control" value="{{ old('title') }}" required autofocus placeholder="Masukkan judul halaman...">
                    ...
                    <div class="sidebar-panel">
                        ...
                        <div id="schedule-group" class="form-group" style="display: {{ old('status') === 'scheduled' ? 'block' : 'none' }}; background: white; padding: 14px; border-radius: 8px; border: 1px solid var(--border-color); box-shadow: var(--shadow-sm);">
                        ...
                        <div class="form-group">
                            ...
                            <small style="color: var(--text-secondary); font-size: 0.75rem; margin-top: 4px; display: block;">Akses halaman di: <code>/slug-halaman</code></small>
                            @error('slug') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="type">Page Type</label>
                            <input type="text" id="type" name="type" class="form-control" value="{{ old('type', 'standard') }}"
                        ...
                        <div style="margin-top: 2rem; display: flex; flex-direction: column; gap: 0.75rem;">
                            <button type="submit" id="submitBtn" class="btn btn-primary" style="width: 100%; justify-content: center;">
                                <i data-feather="save"></i> Simpan Halaman
                            </button>
